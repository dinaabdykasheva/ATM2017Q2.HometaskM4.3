...
public class WriteMailPage extends AbstractPage{
    ...
    public DraftsFolderPage writeMailAndSaveToDraft(String to, String subject, String body) {
        WebElementsUtils.fillInField(driver, TO_FIELD_LOCATOR, to);
        ...
        WebElementsUtils.executeJavaScript(driver, SAVING_LABEL_LOCATOR, "arguments[0].style.border='3px solid green'");
        WebElementsUtils.executeJavaScript(driver, SAVING_LABEL_LOCATOR, "arguments[0].style.border='0px'");
    ...
    public String getReceiver() {
        WebElementsUtils.moveToField(driver, TO_FIELD_LOCATOR);
